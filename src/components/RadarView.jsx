    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', paddingBottom: '24px' }}>
      ...
      <div style={{
        ...
        <span style={{
          ...
          border: `1px solid ${isOngoing ? 'rgba(var(--mizu-rgb), 0.3)' : 'rgba(var(--moss-rgb), 0.3)'}`,
          display: 'flex',
          alignItems: 'center',
          gap: '5px'
        }}>
          ...
          {featuredBunkStats && (
            <div
              ...
              style={{
                ...
                border: `1px solid ${featuredBunkStats.tier === 'danger' ? 'rgba(var(--hanko-rgb), 0.25)' : 'rgba(var(--moss-rgb), 0.25)'}`,
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'space-between',
                cursor: 'pointer'
