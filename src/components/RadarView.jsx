...
import { MapPin, Clock, Copy, Check, Calendar, ArrowRight, User, AlertCircle, Sparkles, Palmtree } from 'lucide-react';
      ...
      {featuredClass ? (
        ...
        >
          ...
          <div style={{
            ...
            >
              <MapPin size={15} style={{ color: 'var(--mizu)' }} />
